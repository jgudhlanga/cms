...
return new class extends Migration
{
    ...
    {
        Schema::create('course_work_import_logs', function (Blueprint $table): void {
            $table->id();
            ...
            $table->index(
                ['tenant_id', 'class_config_id', 'created_at'],
                'cw_import_logs_tenant_config_created_idx',
            );
        });
    }
    ...
    {
        Schema::dropIfExists('course_work_import_logs');
    }
};
