    ...
    public function run(): void
    {
        $permissions = [
            ...
            'institution' => [
                ...
                ['name' => PermissionEnum::VIEW_ANY_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::VIEW_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::CREATE_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::UPDATE_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::DELETE_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::RESTORE_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::FORCE_DELETE_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::IMPORT_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::EXPORT_DOCUMENT_TEMPLATES->value],
                ['name' => PermissionEnum::CRUD_DOCUMENTS_SETTING_TEMPLATES->value],
                ['name' => PermissionEnum::VIEW_DOCUMENT_TEMPLATES_AUDIT_TRAIL->value],
                ['name' => PermissionEnum::VIEW_ANY_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::VIEW_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::CREATE_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::UPDATE_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::DELETE_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::RESTORE_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::FORCE_DELETE_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::IMPORT_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::EXPORT_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::CRUD_FEE_STRUCTURES->value],
                ['name' => PermissionEnum::VIEW_FEE_STRUCTURES_AUDIT_TRAIL->value],
            ],
            'shared' => [
            ...
            'students' => [
                ...
                ['name' => PermissionEnum::VIEW_ANY_STUDENTS->value],
                ['name' => PermissionEnum::VIEW_STUDENTS->value],
                ['name' => PermissionEnum::CREATE_STUDENTS->value],
                ['name' => PermissionEnum::UPDATE_STUDENTS->value],
                ['name' => PermissionEnum::DELETE_STUDENTS->value],
                ['name' => PermissionEnum::RESTORE_STUDENTS->value],
                ['name' => PermissionEnum::FORCE_DELETE_STUDENTS->value],
                ['name' => PermissionEnum::IMPORT_STUDENTS->value],
                ['name' => PermissionEnum::EXPORT_STUDENTS->value],
                ['name' => PermissionEnum::CRUD_STUDENTS_SETTINGS->value],
                ['name' => PermissionEnum::VIEW_STUDENTS_AUDIT_TRAIL->value],
            ],
            'enrolments' => [
                ['name' => PermissionEnum::VIEW_ANY_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::VIEW_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::CREATE_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::UPDATE_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::DELETE_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::RESTORE_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::FORCE_DELETE_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::IMPORT_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::EXPORT_STUDENT_PROGRAMS->value],
                ['name' => PermissionEnum::CRUD_STUDENT_PROGRAMS_SETTINGS->value],
                ['name' => PermissionEnum::VIEW_STUDENT_PROGRAMS_AUDIT_TRAIL->value],
            ],
            'examinations' => [
                ['name' => PermissionEnum::VIEW_ANY_EXAMINATION->value],
                ['name' => PermissionEnum::VIEW_EXAMINATION->value],
                ['name' => PermissionEnum::CREATE_EXAMINATION->value],
                ['name' => PermissionEnum::UPDATE_EXAMINATION->value],
                ['name' => PermissionEnum::DELETE_EXAMINATION->value],
                ['name' => PermissionEnum::RESTORE_EXAMINATION->value],
                ['name' => PermissionEnum::FORCE_DELETE_EXAMINATION->value],
                ['name' => PermissionEnum::IMPORT_EXAMINATION->value],
                ['name' => PermissionEnum::EXPORT_EXAMINATION->value],
                ['name' => PermissionEnum::CRUD_EXAMINATION_SETTINGS->value],
                ['name' => PermissionEnum::VIEW_EXAMINATION_AUDIT_TRAIL->value],
            ],
            'accommodations' => [
                ['name' => PermissionEnum::VIEW_ANY_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::VIEW_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::CREATE_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::UPDATE_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::DELETE_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::RESTORE_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::FORCE_DELETE_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::IMPORT_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::EXPORT_ACCOMMODATIONS->value],
                ['name' => PermissionEnum::CRUD_ACCOMMODATIONS_SETTINGS->value],
                ['name' => PermissionEnum::VIEW_ACCOMMODATIONS_AUDIT_TRAIL->value],
            ],
        ];
