...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            'enrolments' => [
                ['name' => PermissionEnum::VIEW_ANY_ENROLMENTS->value],
                ['name' => PermissionEnum::VIEW_ENROLMENTS->value],
                ['name' => PermissionEnum::CREATE_ENROLMENTS->value],
                ['name' => PermissionEnum::UPDATE_ENROLMENTS->value],
                ['name' => PermissionEnum::DELETE_ENROLMENTS->value],
                ['name' => PermissionEnum::RESTORE_ENROLMENTS->value],
                ['name' => PermissionEnum::FORCE_DELETE_ENROLMENTS->value],
                ['name' => PermissionEnum::IMPORT_ENROLMENTS->value],
                ['name' => PermissionEnum::EXPORT_ENROLMENTS->value],
                ['name' => PermissionEnum::CRUD_ENROLMENTS_SETTINGS->value],
                ['name' => PermissionEnum::VIEW_ENROLMENTS_AUDIT_TRAIL->value],
            ],
            'examinations' => [
