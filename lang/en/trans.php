...
return [
    ...
    "generate_application_fee_verification_report" => "Generate registration fee verification report",
    ...
    "application_fee_payment_failure" => "Something went wrong while marking registration fee as :action",
    ...
    "all_application_fee_required_to_be_paid" => "All applications are required to have registration fee paid before applications are approved",
    ...
    "finish_registration_description" => "You have successfully paid the registration fee. You can now proceed to complete your application",
