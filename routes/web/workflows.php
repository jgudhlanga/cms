...
Route::prefix('workflows')->middleware('auth')->group(function () {
    ...
    Route::post('students/{student_application}/approve-application/{workflow_step}', [ApplicationWorkflowController::class, 'approveApplication'])->name('students.approve-application');
