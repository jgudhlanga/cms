...
Route::prefix('institution')->middleware('auth')->group(function () {
    ...
    Route::get('academic-calendars/department/{institution_department}/classes/{calendar_year}/class-list/export', [AcademicCalendarController::class, 'exportDepartmentAcademicCalendarClassList'])->where('calendar_year', '[0-9]{4}')->name('academic-calendars.department-classes.class-list.export');
    Route::get('academic-calendars/department/{institution_department}/classes/{calendar_year}/show/{academic_calendar_class}/class-list/export', [AcademicCalendarController::class, 'exportDepartmentAcademicCalendarClassListForClass'])->where('calendar_year', '[0-9]{4}')->name('academic-calendars.department-classes.class-list.export-class');
