...
class ContactPolicy
{
	...
	{
		return $user->can(PermissionEnum::UPDATE_CONTACTS, $contact);
	}

	public function delete(User $user, Contact $contact): bool
	{
		return $user->can(PermissionEnum::DELETE_CONTACTS, $contact);
	}

	public function restore(User $user, Contact $contact): bool
	{
		return $user->can(PermissionEnum::RESTORE_CONTACTS, $contact);
	}

	public function forceDelete(User $user, Contact $contact): bool
	{
		return $user->can(PermissionEnum::FORCE_DELETE_CONTACTS, $contact);
	}
}
