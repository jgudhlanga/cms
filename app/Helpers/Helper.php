...
class Helper
{
    ...
    /**
     * Initial password for staff accounts. It is never shown or emailed (staff sign in through
     * "Forgot password"), so it is fully random: name-derived passwords were guessable.
     */
