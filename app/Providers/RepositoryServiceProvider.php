...
use App\Repositories\HMS\HostelAmenityRepository;
...
use App\Repositories\Institution\OfferLetterTemplateRepository;
...
use App\Repositories\Rbac\ModuleRepository;
use App\Repositories\Rbac\PermissionRepository;
use App\Repositories\Rbac\RoleGroupRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(IHostelAmenityRepository::class, HostelAmenityRepository::class);
    ...
    public function institutionRepositories(): void
    {
        ...
        $this->app->bind(IOfferLetterTemplateRepository::class, OfferLetterTemplateRepository::class);
