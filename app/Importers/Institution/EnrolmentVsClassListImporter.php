...
class EnrolmentVsClassListImporter
{
    /** @var list<string> */
     ...
     * @return array{student_number: int|null, level: int|null, course: int|null}
     */
    ...
    /**
     * @param  array<string, mixed>  $row
     * @param  array{student_number: int|null, level: int|null, course: int|null}  $columnMap
     * @return array{student_number: string|null, level: string|null, course: string|null}
     */
    ...
    /**
     * @param  array{student_number: string|null, level: string|null, course: string|null}  $values
     */
