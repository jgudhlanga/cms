...
<div class="container">
    ...
    <div class="content">
        ...
        array_map(fn ($value) => e((string) $value), [$offerLetterDate, strtoupper($studentName), $studentIdNumber, $studentNumber, $intakePeriod, $department, $level, $course, $modeOfStudy, $tuition]),
