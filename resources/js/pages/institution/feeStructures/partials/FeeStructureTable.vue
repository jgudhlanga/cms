...
const { formatCurrency, navigateTo } = useUtils();
</script>
        ...
        <table class="j-table">
            ...
            <tbody class="j-tbody">
                <tr class="j-tr" v-for="fee in feeStructures" :key="fee.id">
                    ...
                    <td class="j-td text-center space-x-2">
                        <BaseButton
                        ...
                        <BaseButton
                            @click="() => navigateTo(route('fee-structures.archive', { fee_structure: fee.id }))"
                        ...
                        <BaseButton
                            @click="() => navigateTo(route('fee-structures.restore', { fee_structure: fee.id }))"
                        ...
                        <BaseButton
                            @click="() => navigateTo(route('fee-structures.force-delete', { fee_structure: fee.id }))"
