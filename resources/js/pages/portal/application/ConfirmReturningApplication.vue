...
const { saveReturningApplication } = useStudentPortal();
...
<template>
    ...
    <div class="mt-20 flex w-full flex-col bg-background px-5 text-foreground md:p-0">
        <div class="flex w-full flex-col space-y-6 md:mx-auto md:w-7/8">
            ...
            <div class="my-5 flex flex-col justify-center space-y-2 md:flex-row md:space-x-3">
                <BaseButton
                    @click="navigateTo(route('portal.application.returning'))"
                    type="button"
