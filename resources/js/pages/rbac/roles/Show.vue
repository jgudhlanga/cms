...
import { useRolePermissions } from '@/composables/rbac/useRolePermissions';
import { forbiddenAlert } from '@/lib/alerts';
import { getIdParams } from '@/lib/utils';
import AddEditRolePermissions from '@/pages/rbac/roles/partials/AddEditRolePermissions.vue';
import RoleShowStats from '@/pages/rbac/roles/partials/RoleShowStats.vue';
