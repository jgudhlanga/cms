...
const UI_LABEL_FALLBACKS: Record<string, string> = {
    ...
    'dashboard.activity_all_types': 'All record types',
    'dashboard.activity_date_range': 'Date range',
    'dashboard.activity_search_placeholder': 'Search by record type or changed value...',
