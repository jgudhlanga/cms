...
export type IntakePeriod = {
    ...
    attributes: {
        ...
        offerLetterTemplateCount?: number;
        createdAt?: string;
        updatedAt?: string;
        deletedAt?: string;
    };
...
export type OfferLetterTemplate = {
    ...
    attributes: {
        ...
        institutionDepartmentIds?: number[];
        departments?: string | null;
        departmentOptions?: Array<{ id: number; name: string; code?: string }>;
        levelIds?: number[];
        levels?: string | null;
        levelOptions?: Array<{ id: number; name: string }>;
        modeOfStudyId?: string | number | null;
        modeOfStudy?: string | null;
        courseId?: string | number | null;
        course?: string | null;
        tuitionOverride?: string | number | null;
        headerLine1: string;
        headerLine2: string;
        headerAddressLine1: string;
        headerAddressLine2: string;
...
export type OfferLetterTemplateParams = {
    name: string;
    helper_description: string;
    institution_department_ids: Array<string | number>;
    level_ids: Array<string | number>;
    course_id: string | number | null;
    mode_of_study_id: string | number | null;
    tuition_override: string | number | null;
    header_line_1: string;
    header_line_2: string;
    header_address_line_1: string;
    header_address_line_2: string;
    ...
    header_email: string;
    header_website: string;
    header_logo_1: string | File;
    header_logo_2: string | File;
    body: string;
};
