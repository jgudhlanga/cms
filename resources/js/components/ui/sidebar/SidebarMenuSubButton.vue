	...
	<Primitive
		...
		:class="
            cn(
                ...
                'data-[active=true]:bg-sidebar-primary/12 data-[active=true]:font-medium data-[active=true]:text-sidebar-foreground data-[active=true]:shadow-[inset_-1px_0_0_0_hsl(var(--sidebar-primary))] data-[active=true]:[&>svg]:text-sidebar-primary',
                size === 'sm' && 'text-xs',
                size === 'md' && 'text-sm',
