...
const computedClass = computed(() => cn(buttonVariants({ variant: props.variant as any }), extendedVariants[props.variant as ColorVariant] || ''));
</script>

<template>
    <Button v-bind="$attrs" :class="cn(computedClass, props.classes, 'cursor-pointer')">
        {{ count }}
    </Button>
</template>
