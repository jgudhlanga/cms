        ...
        <template #body>
            <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
                ...
                <BaseInput
                    ...
                    v-model="form.school"
                    :placeholder="$t('trans.ui_enter_school_institution')"
                ...
                <BaseInput
                    ...
                    v-model="form.place"
                    :placeholder="$t('trans.ui_enter_place_city_town_village_etc')"
                    :label-uppercase="true"
                    :is-required="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_start_level')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_end_level')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_start_date')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_end_date')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_candidate')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_exam_board_zimsec_cambrige')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_month_june_nov_ete')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_year_of_exam')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_exam_center')"
                    :label-uppercase="true"
                ...
                <BaseInput
                    ...
                    :placeholder="$t('trans.ui_enter_exam_results')"
                    :label-uppercase="true"
