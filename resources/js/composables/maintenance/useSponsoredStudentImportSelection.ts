import type { SponsoredStudentImportPreviewRow } from '@/types/sponsored-student-import';
import type { ComputedRef, Ref } from 'vue';
import { computed, ref } from 'vue';

export function useSponsoredStudentImportSelection(
    rows: ComputedRef<SponsoredStudentImportPreviewRow[]>,
): {
    selectedRowNumbers: Ref<number[]>;
    selectAllModel: ComputedRef<boolean>;
    selectedCount: ComputedRef<number>;
    selectableRows: ComputedRef<SponsoredStudentImportPreviewRow[]>;
    selectedRows: ComputedRef<SponsoredStudentImportPreviewRow[]>;
