import type { HostelOccupantImportPreviewRow } from '@/types/hostel-occupant-import';
import type { ComputedRef, Ref } from 'vue';
import { computed, ref } from 'vue';

export function useHostelOccupantImportSelection(
    rows: ComputedRef<HostelOccupantImportPreviewRow[]>,
): {
    selectedRowNumbers: Ref<number[]>;
    selectAllModel: ComputedRef<boolean>;
    selectedCount: ComputedRef<number>;
    selectableRows: ComputedRef<HostelOccupantImportPreviewRow[]>;
    selectedRows: ComputedRef<HostelOccupantImportPreviewRow[]>;
